...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComCpfInexistente_RetornarErrorStatus404(){
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("53336449006")
                .build();
    ...
    @Test
    public void busarCheckin_ComPerfilAdmin_RetornarComStatus200(){
        testClient.get()
                ...
                .jsonPath("dataEntrada").isEqualTo("2023-03-13 10:150:00")
                .jsonPath("vagaCodigo").isEqualTo("A-01");
    }

    @Test
    public void busarCheckin_ComPerfilCliente_RetornarComStatus200(){
        testClient.get()
                .uri("/api/v1/estacionamentos/check-in/{recibo}","20230313-101300")
    ...
    @Test
    public void buscarCheckin_ComReciboInexiste_RetornarErroStatus404(){
        testClient.get()
    ...
    @Test
    public void criarCheckOut_ComReciboInexistente_RetornarErroComStatus404(){
        testClient.put()
    ...
    @Test
    public void buscarEstacionamentos_PorClienteCpfComPerfilCliente_RetornarErroComStatus403(){
        testClient.get()
    ...
    @Test
    public void buscarEstacionamentos_DoClienteLogadoPerfilAdmin_RetornarErroComStatus403(){
        testClient.get()
                .uri("/api/v1/estacionamentos")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient,"ana@email.com.br","123456"))
                .exchange()
