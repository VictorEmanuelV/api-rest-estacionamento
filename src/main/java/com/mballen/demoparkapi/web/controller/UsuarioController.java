...
public class UsuarioController {
    ...
    @Operation(summary = "Criar um novo usuário",description = "Recurso para criar um novo usuário",
        responses = {
            ...
            @ApiResponse(responseCode = "409",description = "Usúario e-mail já cadastrado no sistema",
    ...
    @Operation(summary = "Atualizar senha",description = "Requisição exige um bearer token. Acesso restrito ADMIN|CLIENTE",
            security = @SecurityRequirement(name = "security"),
            responses = {
    ...
    @Operation(summary = "Listar todos os usuários Cadastrados",description = "Requisição exige um bearer token. Acesso restrito ADMIN",
            security = @SecurityRequirement(name = "security"),
            responses = {
